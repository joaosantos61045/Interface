...
export interface InitOutput {
  ...
  readonly _dyn_core__ops__function__Fn_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hde39dc804153eee3: (a: number, b: number) => void;
